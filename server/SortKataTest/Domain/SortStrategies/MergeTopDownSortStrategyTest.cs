...
namespace SortKataTest.Domain.SortStrategies {
    public class MergeTopDownSortStrategyTest {
        private MergeTopDownSortStrategy<int> _mergeTopDownSortStrategy;

        public MergeTopDownSortStrategyTest() {
            this._mergeTopDownSortStrategy = new MergeTopDownSortStrategy<int>();
        }
        ...
        public void Sort_InputIsEmpty_ReturnsEmptyList() {
            ...
            IEnumerable<int> output = this._mergeTopDownSortStrategy.Sort(input);
